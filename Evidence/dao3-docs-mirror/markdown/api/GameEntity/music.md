---
title: "音乐音效"
source: "https://docs.dao3.fun/api/GameEntity/music.html"
---
...
#### chatSound:[GameSoundEffect](/api/GameWorld/music.md#GameSoundEffect)

> 默认值：'audio/chat.mp3'

当实体说话时，播放聊天音效。通过`say()`触发。

#### hurtSound:[GameSoundEffect](/api/GameWorld/music.md#GameSoundEffect)

> 默认值：'audio/hurt.mp3'

当实体触发受伤事件时，播放受伤音效。通过`onTakeDamage()`触发

#### dieSound:[GameSoundEffect](/api/GameWorld/music.md#GameSoundEffect)

> 默认值：'audio/die.mp3'

当实体触发死亡事件时，播放死亡音效。通过`onDie()`触发

#### interactSound:[GameSoundEffect](/api/GameWorld/music.md#GameSoundEffect)
