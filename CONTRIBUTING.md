...
- Regenerate affected ABI/report artifacts under `Middleware/runtime-compat/` when source behavior or evidence mapping changes.
...
- `dump/private/`, `works/private/`, local reference worktrees, `.workspace/`, `NEA-Project.7z`, or private map/script source.
