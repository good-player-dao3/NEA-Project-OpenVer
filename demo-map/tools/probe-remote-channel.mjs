...
const baseUrl = process.env.NEA_DEMO_URL ?? "http://127.0.0.1:4322";
const controlUrl = process.env.NEA_DEMO_CONTROL_URL ?? "http://127.0.0.1:4323";
const controlToken = process.env.NEA_DEMO_CONTROL_TOKEN ?? "nea-stage4-test-token";
