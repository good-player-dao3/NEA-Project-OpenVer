...
const runtimeSource = await readFile(new URL("../../demo-map/src/runtime/script-runtime.mjs", import.meta.url), "utf8");
const formatSource = await readFile(new URL("../../demo-map/src/format.mjs", import.meta.url), "utf8");
const manifestSource = await readFile(new URL("../../demo-map/src/capability-manifest.mjs", import.meta.url), "utf8");
const gateSource = await readFile(new URL("../../demo-map/src/capability-launch-gate.mjs", import.meta.url), "utf8");
