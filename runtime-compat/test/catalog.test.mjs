...
test("historical player motor does not locally rewrite body half extents", async () => {
  ...
  assert.deepEqual(analysis.corroboration.lokibox.boundsFields, ["rx", "ry", "rz"]);
  assert.deepEqual(analysis.corroboration.lokibox.shapeHalfExtentFields, ["hsx", "hsy", "hsz"]);
