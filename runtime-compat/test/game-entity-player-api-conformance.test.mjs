...
import { ScriptRuntime, createRuntimeEntity } from "../../demo-map/src/runtime/script-runtime.mjs";
...
test("GameEntity.player distinguishes ordinary entities from RuntimePlayer", async () => {
  ...
  const physics = JSON.parse(await readFile(new URL("../../demo-map/project/world/physics.json", import.meta.url), "utf8"));
