...
import { GameRGBColor, GameRGBAColor } from "../../demo-map/src/runtime/colors.mjs";
...
test("GameRGBColor and GameRGBAColor preserve recovered component semantics", () => {
  ...
  assert.deepEqual(rgb.lerp(new GameRGBColor(1, 0, 0), 0.5), new GameRGBColor(0.6, 0.2, 0.3));
