export const playerDisconnectDestroyOrderConformance = Object.freeze({
  ...
  localEvidence: "demo-map/src/runtime/script-runtime.mjs:removePlayer",
  behavioralEvidence: "demo-map/test/runtime.test.mjs:destroyed chat endpoints are silent and player removal emits recovered destroy ordering",
