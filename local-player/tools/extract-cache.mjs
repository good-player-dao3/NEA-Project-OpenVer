...
const cacheRoot = join(projectRoot, "dump/private/live-session-profile/Default/Service Worker/CacheStorage");
...
async function exposeAssets() {
  const groups = [
    ["dump/recovered-engine-assets", "assets/engine"],
    ["dump/recovered-avatar-assets", "assets/avatar"],
  ];
  const assets = [];
