...
const playerModule = await import(new URL("../../Lokibox/box-go/protocol.ts", import.meta.url));
const scriptProtocols = JSON.parse(await readFile(join(projectRoot, "origin/server-protocols.json"), "utf8"));
...
const playerProtocols = Object.entries(playerModule)
