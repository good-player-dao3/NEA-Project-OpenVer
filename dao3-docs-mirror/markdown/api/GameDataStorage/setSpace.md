---
title: "操作数据"
source: "https://docs.dao3.fun/api/GameDataStorage/setSpace.html"
---
...
#### set(key: string,value:[JSONValue](./setSpace.md#JSONValue)): Promise‹void›
...
#### get(key: string): Promise‹[ReturnValue](./setSpace.md#ReturnValue)›
...
#### update(key: string,handler:(prevValue:[ReturnValue](./setSpace.md#ReturnValue))=>[JSONValue](./setSpace.md#JSONValue)): Promise‹void›
...
#### remove(key: string): Promise‹[ReturnValue](./setSpace.md#ReturnValue)›
...
#### list(options:Partial‹[ListPageOptions](./setSpace.md#ListPageOptions)›): Promise‹[QueryList](./setSpace.md#QueryList)›
...
列表根据配置项被划分为一个或多个分页，每个分页最多包含 {[QueryList](./setSpace.md#QueryList)| pageSize} 个键值对。

| **参数** | **类型** | **说明** |
| --- | --- | --- |
| isLastPage | boolean | 是否为最后一页，如果翻过头了，也会为 true |
| getCurrentPage() | ()=>[ReturnValue](./setSpace.md#ReturnValue)[] | 按 {QueryList \| pageSize} 获取当前页的键值对，返回当前页的键值对内容 |
