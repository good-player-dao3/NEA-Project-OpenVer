---
title: "获取数据空间"
source: "https://docs.dao3.fun/api/GameDataStorage/getSpace.html"
---
...
#### getDataStorage(key: string):[GameDataStorage](./setSpace.md)
...
#### getGroupStorage(key: string):[GameDataStorage](./setSpace.md)
