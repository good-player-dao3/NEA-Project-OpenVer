---
title: "战斗与生命值"
source: "https://docs.dao3.fun/api/GameWorld/fight.html"
---
...
| **参数** | **必填** | **默认值** | **类型** | **说明** |
| --- | --- | --- | --- | --- |
| handler | *是* |  | function | 监听到有实体受到伤害时的处理函数 |
...
| **参数** | **必填** | **默认值** | **类型** | **说明** |
| --- | --- | --- | --- | --- |
| handler | *是* |  | function | 监听到有实体死亡时的处理函数 |
...
#### 事件onRespawn(handler:(event:[GameRespawnEvent](./fight.md#GameRespawnEvent))=>void):[GameEventHandlerToken](/api/GameEventHandlerToken/index.md)
...
| **参数** | **必填** | **默认值** | **类型** | **说明** |
| --- | --- | --- | --- | --- |
| handler | *是* |  | function | 监听到有实体复活时的处理函数 |
...
| **参数** | **类型** | **说明** |
| --- | --- | --- |
| entity | [GamePlayerEntity](/api/GameEntity/isPlayer.md) | 死亡的实体 |
| tick | number | 事件发生时间 |
