---
title: "对话与互动"
source: "https://docs.dao3.fun/api/GamePlayerEntity/chat.html"
---
...
#### dialog(config:Partial<[GameDialogCall](./chat.md#GameDialogCall)>): Promise<[GameDialogResponse](./chat.md#GameDialogResponse)>
...
#### 事件onChat(handler:(event:[GameChatEvent](/api/GameWorld/chat/resident.md#GameChatEvent))=>void):[GameEventHandlerToken](/api/GameEventHandlerToken/index.md)
...
| **参数** | **类型** | **说明** |
| --- | --- | --- |
| type | [GameDialogType](./chat.md#GameDialogType) | **必选**，对话框的类型。 |
| content | string | **必选**，对话框显示的正文内容。支持使用'' 换行。 |
| contentBackgroundColor | [GameRGBAColor](/api/GameRGBAColor/index.md) | 对话框正文窗口的背景颜色。 |
| contentTextColor | [GameRGBAColor](/api/GameRGBAColor/index.md) | 对话框正文字体的颜色。 |
| title | string | 对话框显示的标题名称。 |
| titleBackgroundColor | [GameRGBAColor](/api/GameRGBAColor/index.md) | 对话框显示的标题窗口背景颜色。 |
| titleTextColor | [GameRGBAColor](/api/GameRGBAColor/index.md) | 对话框显示的标题字体颜色。 |
...
| lookTarget | [GameVector3](/api/GameVector3/index.md)\|[GameEntity](/api/GameEntity/index.md) | 使相机镜头朝向指定实体或坐标的位置。 |
| lookTargetOffset | [GameVector3](/api/GameVector3/index.md) | 如果相机指定了注视目标，可以设置基于目标位置的偏移。 |
| lookUp | [GameVector3](/api/GameVector3/index.md) | 调整相机抬头向量。使画面上下左右颠倒。 |
| lookEye | [GameVector3](/api/GameVector3/index.md)\|[GameEntity](/api/GameEntity/index.md) | 调整相机的位置。 |
| lookEyeOffset | [GameVector3](/api/GameVector3/index.md) | 如果相机位置指定了实体，可以设置基于目标位置的偏移。 |
...
如果是选项对话框，回应[GameDialogSelectResponse](./chat.md#GameDialogSelectResponse)
